    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AffectedSectorses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AffectedSectorses_Tasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AffectedSectorses_TaskId",
                table: "AffectedSectorses",
                column: "TaskId");
